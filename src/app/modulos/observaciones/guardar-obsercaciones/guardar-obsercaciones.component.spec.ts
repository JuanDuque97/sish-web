...
import { GuardarObsercacionesComponent } from './guardar-obsercaciones.component';
...
import { ServiciosArchivoCampos } from '../../configuracion/tipo-archivos/servicios-archivo-campos.service';
...
describe('GuardarObsercacionesComponent', () => {
  let component: GuardarObsercacionesComponent;
  let fixture: ComponentFixture<GuardarObsercacionesComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
        ...
        RouterTestingModule.withRoutes([
          {
            ...
            component: GuardarObsercacionesComponent,
          },
        ]),
      ...
      declarations: [GuardarObsercacionesComponent],
      schemas: [NO_ERRORS_SCHEMA],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(GuardarObsercacionesComponent);
...
component.datosFilter = [
 ...
 var observacionParametros = {
  ...
  component.validarObservacion(observacionParametros);
    expect(Swal.isVisible()).toBeTruthy();
    Swal.clickConfirm();
expect(component.validarObservacion).toBeTrue(); 
})
